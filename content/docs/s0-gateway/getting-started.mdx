...
- [S0 Pinouts](/s0-gateway/pinouts) — Pin assignments and header descriptions
- [S0 Architecture](/s0-gateway/architecture) — Board schematics and circuit diagrams
- [Software Overview](/s0-gateway/software) — Communication protocols and examples
- [Base Board](/base-board) — Expand S0 with Ethernet, M-Bus, and power management
