...
For detailed setup instructions, hardware pin-outs, and integration guides, refer to the [S0 Gateway docs](/s0-gateway) for the wireless module and the [BeagleV-Fire documentation](https://www.beagleboard.org/boards/beaglev-fire) for the Linux board.
